...
import com.neo.sk.cactus.snake.Protocol.GridDataSync
import com.neo.sk.cactus.snake._
...
object NetGameHolder {
  ...
  def getWebSocketUri(document: Document, nameOfChatParticipant: String): String = {
    ...
    s"$wsProtocol://${dom.document.location.host}/cactus/netSnake/join?name=$nameOfChatParticipant"
  }
