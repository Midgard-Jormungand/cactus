...
import com.neo.sk.cactus.http.HttpService
...
object Boot extends HttpService {
  ...
  import com.neo.sk.cactus.common.AppSettings._


  override implicit val system = ActorSystem("cactus", config)
