package com.neo.sk.cactus.http
...
import com.neo.sk.cactus.snake.PlayGround
...
trait SnakeService {
  ...
  private[this] val log = LoggerFactory.getLogger("com.neo.sk.cactus.http.SnakeService")
